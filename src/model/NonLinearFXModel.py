from tensorflow.keras.layers import Dense, Input, Activation, Conv1D, MaxPool1D, BatchNormalization, LocallyConnected1D, Dropout, UpSampling1D, Lambda, multiply, Reshape, ZeroPadding1D, Flatten, ELU
...
class NonLinearFXModel():
    ...
    def build(self):
        ...
        self.w1 = Conv1D(filters=128, kernel_size=64,
                   ...
                   name='conv1')
        self.w2 = LocallyConnected1D(filters=128, kernel_size=128,
                   activation='softplus',
                   kernel_initializer='random_uniform',
                   name='conv2')
